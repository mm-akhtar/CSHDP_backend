# -*- coding: utf-8 -*-
"""
Created on Mon Jan 17 18:20:56 2022

@author: kkakh
"""

# XG_boost classification
...
print(XGB.Get_Result())

#predict = XGB.predict([37,1,4,140,207,0,0,130,1,1.5,2])
...
output in %:
    {'General': 
        {'Precision': 94.66, 'Recall': 96.13, 'Accuracy': 91.39, 'F1_Score': 95.39},
    'PCA': 
        {'Precision': 94.66, 'Recall': 96.13, 'Accuracy': 91.39, 'F1_Score': 95.39}
    }
"""