# -*- coding: utf-8 -*-
"""
Created on Mon Jan 17 15:08:01 2022
...
print(KNN.Get_Result())

predict = KNN.predict([37,1,4,140,207,0,0,130,1,1.5,2])
...
output in %:
    {'General': 
        {'Precision': 83.47, 'Recall': 82.18, 'Accuracy': 84.57, 'F1_Score': 82.82},
    'PCA': 
        {'Precision': 81.96, 'Recall': 84.5, 'Accuracy': 83.31, 'F1_Score': 83.21}
    }
"""